...
# 1. 頁面基本配置
st.set_page_config(page_title="李兆勛專題：勝利手勢偵測", layout="wide")

# --- 側邊欄 (Sidebar) ---
st.sidebar.header("📁 李兆勛基本資料")
school = st.sidebar.text_input("高中名稱", "南大附屬高級中學")
name = st.sidebar.text_input("學生姓名", "李兆勛")
